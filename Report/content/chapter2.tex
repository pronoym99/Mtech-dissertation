...
The fundamental difference between YoLov4 and all its previous variants is that the detector stage has been bifurcated into two distinct sections consisting of a \textit{single stage – detector} and \textit{sparse prediction stage}. Here is an image of the same.
