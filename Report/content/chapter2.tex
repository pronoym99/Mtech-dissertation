...
\begin{subfigure}{0.5\textwidth}
  \includegraphics[width=0.5\linewidth, height=6cm]{chapter2/person.jpeg}
  \caption{A sample image taken from the original Darknet github repository}
  \label{fig:person_sub1}
 \end{subfigure}
 \begin{subfigure}{0.5\textwidth}
  \includegraphics[width=0.5\linewidth, height=6cm]{chapter2/personresult.png}
